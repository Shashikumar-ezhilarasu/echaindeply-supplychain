              ...
              {!userData ? (
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full bg-purple-600 text-white py-3 px-6 rounded-lg font-semibold shadow-lg hover:bg-purple-700 transition-all duration-200 hover:scale-105"
                  >
                    Connect Wallet
                  </button>
